...
var HeroSearchComponent = (function () {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.heroes = this.searchTerms
            ...
            .switchMap(function (term) { return term // switch to new observable each time the term changesreturn the http search observable
            ? _this.heroSearchService.search(term) // or the observable of empty heroes if there was no search term
